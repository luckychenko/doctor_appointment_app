...
doctors: dict[int, Doctor] = {
    0: Doctor(id=0, name="Mark Ogbor", specialization="Pediatrics", phone="08139585870"),
    1: Doctor(id=1, name="Samchi Akpan", specialization="Ophthalmology", phone="09136985450"),
    2: Doctor(id=2, name="Zainab Musa", specialization="Dermatology", phone="09055665881")
}